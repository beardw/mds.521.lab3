...
author: "Hector, Joel, Selene, Wesley"
...
<https://github.ubc.ca/mds-2025-26/DSCI_521_lab3_group20>
...
for this assignment we'll treat it as an exception becauuse we want to
...
some_variable <- 3
other_variable <- 4
some_operation <- (some_variable+other_variable)
some_operation <- 5
some_operation

```

**eval = FALSE** is preventing the lines from being executed at all at
...
```{r chunky2, results = 'hide', message = FALSE}
a_vector <- c(1, 2, 3)
a_vector * 2
...
**results = 'hide'** makes it so that the code hides the results from
the execution of the chunk.

**message = FALSE** hides the messages produced, for instance, from
prints and warnings.

This is what happens if we do not include those parameters

```{r not_chunky2}


print("this one will show up")
a_vector * 3
...
<https://github.ubc.ca/mds-2025-26/DSCI_521_lab3_group20/blob/master/question_7.html>
<https://github.ubc.ca/mds-2025-26/DSCI_521_lab3_group20/blob/master/question_7.pdf>
<https://github.ubc.ca/mds-2025-26/DSCI_521_lab3_group20/blob/master/question_7.Rmd>
...
<https://github.ubc.ca/mds-2025-26/DSCI_521_lab3_group20/blob/master/question_8.Rmd>
<https://github.ubc.ca/mds-2025-26/DSCI_521_lab3_group20/blob/master/question_8.html>
...
<https://github.ubc.ca/mds-2025-26/DSCI_521_lab3_group20/blob/master/question_9.md>

In the preview it is rendered as an R markdown environment. So it
carries the order as the visual .Rmd documents are displayed. The code
part looks like the source .Rmd file but with more order, not as
detailed either. We can see that our headers are based on the number of
\# used. Our code is now easily copy-able. And code that generates plots
and images is run and the results are rendered to the page.
